/*
 * com.example.menno_000.madlibs.Story.java
 * Madlibs
 *
 ...
 * A com.example.menno_000.madlibs.Story is Serializable, so it can be packed into an Intent as "extra" data.
 */
...
public class Story implements Serializable {
    ...
    /** constructs a new com.example.menno_000.madlibs.Story reading its text from the given input stream */
